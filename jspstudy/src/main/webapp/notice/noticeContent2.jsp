<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="jspstudy.domain.NoticeVo" %>
...
<input type="button" name="btn" value="목록" onclick="location.href='<%=request.getContextPath()%>/notice/noticeList.do'"> <!-- 목록 버튼을 누를 경우 게시판 목록으로 넘어가도록 수행하는 코드 -->
</body>