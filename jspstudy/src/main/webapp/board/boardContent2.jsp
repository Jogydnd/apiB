...
<td style="text-align:left">조회수<br><%=bv.getHits()%></td>
</tr>
<tr>
<td><div>
         ...
         <br>
         <button type="button" id="btnReply" style="font: 16px -apple-system, BlinkMacSystemFont; Color:#FFFFFF; Background:#12B886; Padding:0px 20px; ">댓글쓰기</button>
</div></td>
</tr>
</tfoot>
</table>
...
<input type="hidden" value="<%=rv.getBidx()%>" class="ridx"></div>
