...
<thead>
<tr><th><h1><%=bv.getsubject() %></h1></th></tr>
<tr>
<th style="text-align:right"><%=bv.getwriter() %></th>
...
<td>사용했던 교통수단<br><%=bv.getTransportation() %></td>
</tr>
</tbody>
<tfoot>
<tr>
...
<tr>
<td><input type="button" name="btn" value="목록" onclick="location.href='<%=request.getContextPath()%>/board/boardList.do'"></td> 
<td><h4>조회수</h4><%=bv.getHits()%></td>
</tr>
<tr>
<td colspan=2><div>
         ...
         <br>
         <button type="button" id="btnReply" style="font: 16px -apple-system, BlinkMacSystemFont; Color:#FFFFFF; Background:#12B886; Padding:0px 20px; text-align:right ">댓글쓰기</button>
</div></td>
</tr>
</tfoot>
</table>
